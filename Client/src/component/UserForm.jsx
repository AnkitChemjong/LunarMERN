...
const Login = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    try{
      ...
      if (props.type === "sign") {
        if (
          handleSignUp(data.userName, data.email, data.password, data.userImage)
        ) {
  ...
  if (mutation.isError) return <div>Error: {mutation.isError}</div>;
  return (
